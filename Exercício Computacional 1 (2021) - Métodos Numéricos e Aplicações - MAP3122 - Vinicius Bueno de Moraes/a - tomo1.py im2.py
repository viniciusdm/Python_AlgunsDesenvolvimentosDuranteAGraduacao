...
print()
print("Exercício 1 - tomo1.py - im2")
...
for m in deltas:
    ...
    print()
    print("A matriz referente a im2 original (f) se encontra abaixo: ")
    print()
    print(data)
    print()
    ...
    plt.suptitle("Análise ref. ao Exercício 1 - tomo1.py - im2 | n = %s e Delta = %s " % (n, deltas[o]))
    plt.subplot(1, 2, 1)
