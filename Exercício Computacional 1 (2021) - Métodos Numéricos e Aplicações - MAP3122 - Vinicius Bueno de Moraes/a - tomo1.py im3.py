...
for m in deltas:
    ...
    print()
    print("A matriz referente a im3 original (f) se encontra abaixo: ")
    print()
    print(data)
    print()
    ...
    plt.suptitle("Análise ref. ao Exercício 1 - tomo1.py - im3 | n = %s e Delta = %s " % (n, deltas[o]))
    plt.subplot(1, 2, 1)
